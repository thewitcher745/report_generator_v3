...
styling_dict = {
    ...
    "lbank_1": {
        "symbol_perp_futures": ElementStyling(
            ...
            symbol_font="Yantramanav-Black.ttf",
            symbol_font_size=30,
            symbol_color="white",
            gap=20,
            pill_font="Yantramanav-Regular.ttf",
            pill_font_size=20,
            pill_text_color="white",
            pill_bg_color="#2d2e33",
            pill_radius=15,
            pill_padding_x=9,
            pill_padding_y=2,
        ),
        "close_signal_leverage": ElementStyling(
            position=Position(x=0.06916530049809513, y=0.20819344280435026),
            font="Yantramanav-Regular.ttf",
            font_size=30,
            short_color="#bb5c71",
            long_color="#23b584",
            separator_color="#888888",
            separator_margin_x=7,
            leverage_color="#888888",
        ),
        "roi": ElementStyling(
            position=Position(x=0.06834157726910008, y=0.3549960019777147),
            font="Yantramanav-Black.ttf",
            font_size=85,
            color="#23b584",
        ),
        "entry": ElementStyling(
            position=Position(x=0.06834157726910008, y=0.5855915243391224),
            font="Yantramanav-Regular.ttf",
            font_size=30,
            color="white",
        ),
        "target": ElementStyling(
            position=Position(x=0.06834157726910008, y=0.7011990444265681),
            font="Yantramanav-Regular.ttf",
            font_size=30,
            color="white",
        ),
    ...
    "lbank_2": {
        "symbol_perp_futures": ElementStyling(
            ...
            pill_font="Yantramanav-Regular.ttf",
            pill_font_size=20,
            pill_text_color="black",
            pill_bg_color="#edeef0",
            pill_radius=15,
            pill_padding_x=9,
            pill_padding_y=2,
        ),
        ...
        "qr": ElementStyling(position=Position(0.815, 0.866), size=83),
    },
    "lbank_3": {
        "symbol_signal_type_leverage": ElementStyling(
    ...
    "blofin_1": {
        "date": ElementStyling(
            position=Position(x=0.6904902882423265, y=0.8843307495117188),
            font="BlofinNova-Medium.woff2",
            font_size=20,
            color="#999",
        ),
        "symbol": ElementStyling(
            position=Position(x=0.030427039023113136, y=0.35334618763573844),
            font="BlofinNova-SemiBold.woff2",
            font_size=26,
            color="white",
        ),
        "signal_type_leverage": ElementStyling(
            position=Position(x=0.03291814946619217, y=0.42348777741538973),
            font="BlofinNova-Medium.woff2",
            font_size=21,
            short_color="#d95374",
            long_color="#34b785",
        ...
        "roi": ElementStyling(
            position=Position(x=0.031593512809997774, y=0.5317567508653324),
            font="BlofinNova-Bold.woff2",
            font_size=58,
            color="#2ebd88",
        ),
        "entry": ElementStyling(
            position=Position(x=0.16221826809015422, y=0.8286357570338894),
            font="BlofinNova-Medium.woff2",
            font_size=21,
            color="white",
        ),
        "target": ElementStyling(
            position=Position(x=0.16221826809015422, y=0.883494167254238),
            font="BlofinNova-Medium.woff2",
            font_size=21,
            color="white",
        ),
        "referral": ElementStyling(
            position=Position(x=0.7705219309525133, y=0.8253539391005822),
            font="BlofinNova-SemiBold.woff2",
            font_size=23,
            color="white",
        ),
        "qr": ElementStyling(
            position=Position(x=0.9035784991751927, y=0.8253861062775247), size=60
        ),
    },
}
